...
public class WeChatToolCom implements Serializable {
   public static String wxspAppid="wxfbd5b1408a2efa9e";
    public static String wxspSecret="cdb6851471d047204ff3f8992d599028";
    /*获取唯一openid的提醒*/
